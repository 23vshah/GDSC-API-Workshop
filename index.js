...
function greet(name) {
  ...
  console.log(person.children.kids)
  ...
  const squares2 = numbers.map((value, index) => {
...
//
  ...
  async function dallEGen(){
    const bodyData = {
        prompt: `College Campus floating with football field`,
        n: 1,
        size: '1024x1024',
        response_format: "url",
    };
    const config = {
        ...
        headers: {
          ...
          'Authorization': 'Bearer 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'
        },
